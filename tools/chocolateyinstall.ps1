...
$url        = 'https://github.com/dmitry-merzlyakov/nledger/releases/download/v0.7/NLedger-v0.7.msi' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'nledger*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
